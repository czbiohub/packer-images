#!/bin/bash -x
##During the packer build process for pac bio image - this script is copied to /var/lib/cloud/scripts/per-instance and thus will be run each time instance is launched
cd /mnt/data
